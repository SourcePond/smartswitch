...
public class SmartSwitchTest {
    ...
    private  SmartSwitch<TestService> smartSwitch = new SmartSwitchFactory().create(executorService, supplier, null, observer);
    ...
    public void callShutdownHookIfAvailable() throws Throwable {
        smartSwitch = new SmartSwitchFactory().create(executorService, supplier, shutdownHook, observer);
